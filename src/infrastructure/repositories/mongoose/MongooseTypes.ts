...
export const EntityStatsType: mongoose.SchemaDefinition<
  EntityStats & { _id: String }
> = {
  maxLife: Number,
  runSpeed: Number,
  walkSpeed: Number,
...
export const EnemyStatsType: mongoose.SchemaDefinition<
  EnemyStats & { _id: String }
> = {
  height: Number,
  width: Number,
...
export const EntityInfoType: mongoose.SchemaDefinition<
  EntityInfo & { _id: String }
> = {
  id: { required: true, type: String, unique: true },
  name: String,
};

export const PlayerInfoType: mongoose.SchemaDefinition<
  PlayerInfo & { _id: String }
> = {
  ...EntityInfoType,
  accountId: String,
};
...
const AnimationDtoType: mongoose.SchemaDefinition<
  AnimationDto & { _id: String }
> = {
  name: String,
  layer: String,
...
export const EntityStateType: mongoose.SchemaDefinition<
  EntityState & { _id: String }
> = {
  life: Number,
  position: VectorType,
  velocity: VectorType,
  anim: { type: [AnimationDtoType] },
...
export const PlayerStateType: mongoose.SchemaDefinition<
  PlayerState & { _id: String }
> = {
  ...EntityStateType,
