...
var InitGame = function (socket) {
    ...
    socket.on(socketIoEvents_1.SocketIOEvents.CONNECTION, function (clientSocket) {
        ...
        (0, Logger_1.Log)("InitServerGame", "[Event: ".concat(socketIoEvents_1.SocketIOEvents.CONNECTION, "] :: with connection id: ").concat(clientSocket.id));
        clientSocket.on(socketIoEvents_1.SocketIOEvents.DISCONNECT, function () {
            ...
            (0, Logger_1.Log)("InitServerGame", "[Event: ".concat(socketIoEvents_1.SocketIOEvents.DISCONNECT, "] :: with connection id: ").concat(clientSocket.id));
        });
    });
};
